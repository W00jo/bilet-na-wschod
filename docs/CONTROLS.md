...
- **[F]** - Szczegółowe sprawdzenie dokumentu/biletu
...
5. **Sprawdź bilet** - Naciśnij **[Q]** aby powiększyć dokument
...
4. **Szczegółowe sprawdzenie** - Naciśnij **[F]** aby zweryfikować autentyczność
5. **Porównaj dane** - Sprawdź zgodność danych między biletem a dokumentem
...
4. **Strona 5-6** - Porady ogólne dla konduktorów
5. **Strona 7-8** - Twoje statystyki pracy (na żywo)
...
- **[LMB]** - Pobieranie dokumentów, klikanie UI
- **[Q]** - Powiększanie dokumentów
- **[F]** - Szczegółowe sprawdzenie dokumentów
- **[ESC]** - Menu pauzy, zamykanie okien
- **[Spacja]** - Kontynuacja dialogów
...
- **[LMB]** - Kliknij opcję dialogową

## Porady dla nowych konduktorów

1. **Przeczytaj kompendium na początku** - Zapoznaj się z procedurami na stronie 3-4
...
5. **Postępuj zgodnie z przepisami** - Kompendium zawiera wszystkie niezbędne zasady
6. **Monitoruj statystyki** - Sprawdzaj swoje postępy na stronie 7-8 kompendium
7. **Używaj glosariusza** - Strona 9 wyjaśnia wszystkie pojęcia kolejowe
8. **Praktyka czyni mistrza** - Użyj tutoriala aby nauczyć się systemów
...
- **Powiększanie dokumentów** - Q dla zoom
- **Szczegółowe sprawdzenie** - F dla dodatkowej weryfikacji
- **Menu pauzy** - ESC do otwierania/zamykania
...
- **Gestykulacja** - Dodatkowe animacje interakcji
